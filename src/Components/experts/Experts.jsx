...
import { Alert, Button, ButtonGroup, Dropdown, DropdownButton, Modal } from 'react-bootstrap';
import ContentLoader from 'react-content-loader';
import axiosClient from '../../axiosClientOffline';
import AddTelegram from './AddExpert';
import EditTelegram from './EditExpert';
    ...
    return (
      <>
          ...
          >
            ...
            <Modal.Footer>
            <Button variant="danger" style={{ width: "10rem",backgroundColor:"red",borderColor:"#f0ad4e",margin:"auto" }} onClick={handleDeleteConfirm}>
                Delete
              </Button>
              <Button
                variant="secondary"
                style={{ width: "10rem",backgroundColor:"black",borderColor:"#f0ad4e",margin:"auto" ,color:"white" }}
              ...
              <tbody>
                {telegrams? telegrams.map((telegram, index) => (
                  <tr key={telegram.id}>
                    ...
                    <td>{telegram.plan? telegram.plan.map((myPlan) => myPlan.name + " "): "No paln"}</td>
          ...
          <Modal show={show} onHide={handleClose}>
            <Modal.Header closeButton>
              <Modal.Title>Edit Experts</Modal.Title>
            </Modal.Header>
            <Modal.Body>{selectedTelegram && <EditTelegram telegram={selectedTelegram} />}</Modal.Body>
            <Modal.Footer>
