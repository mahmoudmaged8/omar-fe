...
export const Posts = () => {
  ...
  const fetchPosts = async () => {
    try {
      ...
      if (err.message == "Network Error") {
        ...
        setErrorMessage(`Error fetching post : ${err.message}`);
      }
    } finally {
      setLoading(false);
    }
  ...
  const handleDeleteConfirm = async () => {
    try {
      await axiosClient.delete(`post/${selectedPostDelete.id}`);
              ...
              posts
                ...
                .map((post, index) => (
                  <tr key={post.id}>
                    ...
                    <td>
                      {post.link ? <a href={post.link}>meet here</a> : ""}
                    </td>
                    <td>
                      {post.status
                        ? post.status == "is_advice"
                          ? "النصائح"
                          : "الارشيف"
                        : ""}
                    </td>
