...
export default function SuperAdmin() {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      setSuperAdmin(superAdmins.filter((superAdmin) => superAdmin.id !== id));
  ...
  return (
    <>
      <Modal show={showCreate} onHide={handleCloseCreate}>
        <Modal.Header closeButton>
          <Modal.Title>Create Super Admin</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <AddUser
    ...
    {Array(10)
      ...
      .map((e, i) => (
        ...
        <>
          <Button onClick={handleShowCreate}>Add Super Admin</Button>
            ...
            <table className="table table-borderless">
              <thead>
                <tr>
                  ...
                  <th scope="col">وقت انتهاء الخطة</th>
                  <th scope="col">الأموال في المحفظة</th>
                  <th scope="col">الأموال في الFees</th>
